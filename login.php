...
$sql1="select * from admin where admin_email='$email'and admin_pass='$token'";
...
// --> 
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow" style="border-top: 2px solid #ff6000;">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        ...
        <a class="p-2 text-dark" href="#">Restaurants</a>
        <a class="p-2 text-dark" href="#">Contact Us</a>
        <a class="p-2 text-dark" href="">|</a>
              
      </nav>

      <a class="btn btn-sm btn-outline-warning" href="">Sign Up</a>
   ...
   <div class="row">
       ...
       <div class="py-5 text-center">
        ...
        <h2 style="color: #ff6000;">PODZO</h2>
      </div>
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        ...
        <div class="card card-signin my-5" style="border-top: 4px solid #ff6000;border-radius: 5px;">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title text-center" style="font-style: italic;">Login Now !</h5>
            ...
            <form class="form-signin" method="POST">
              ...
              <div class="form-label-group">
                <input type="password" id="inputEmail" name="password" class="form-control" placeholder="Password" required autofocus>
                
              </div>

              <div class="form-label-group">
                 <button type="submit" name="login_into_system" class="btn btn-sm btn-outline-success">Login</button>
              </div>
