      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        ...
        <div class="card card-signin my-5" style="border-top: 4px solid #ff6000;border-radius: 5px;">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title text-center" style="font-style: italic;">Register New Restaurant</h5>
...
$t1=mysqli_real_escape_string($conn,$_POST['rename']);

$t2=mysqli_real_escape_string($conn,$_POST['reloc']);

$t3=mysqli_real_escape_string($conn,$_POST['rephone']);


$ins=mysqli_query($conn,"INSERT INTO `resto`(`re_id`, `re_name`, `re_location`, `re_phone`) VALUES(Null,'$t1','$t2','$t3')");
...
?>
              ...
              <div class="form-label-group">
                ...
                <input type="text" id="inputEmail" name="rename" class="form-control" placeholder="Restaurant Name" required autofocus>
                
              </div>


              <div class="form-label-group">
                <input type="text" id="inputEmail" name="reloc" class="form-control" placeholder="Restaurant Location" required autofocus>
                
              </div>

              <div class="form-label-group">
                <input type="text" id="inputEmail" name="rephone" class="form-control" placeholder="Restaurant Phone" required autofocus>
                
              </div>

              <div class="form-label-group">

    <button type="submit" name="save_notice" class="btn btn-sm btn-success">Add Resto</button>
