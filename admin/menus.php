...
// --> 
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow" style="border-top: 2px solid #ff6000;">
      ...
      <a class="navbar-brand logo" href="index.html"><img src="images/podzo.png" style="width: 120px;" alt=""/></a>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="card card-signin my-5" style="border-top: 4px solid #ff6000;border-radius: 5px;">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title text-center" style="font-style: italic;">Restaurants Menu List</h5>

        <a href="new_menu.php"class="btn btn-warning"><i class="fa fa-check-circle"></i> <span>Add New</span></a> <br><br>
            ...
            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                ...
                $user_query1 = mysqli_query($conn,"SELECT * FROM resto,menu where resto.re_id=menu.re_id");
                ...
                <td><?php echo $row['me_take'];?></td>
                <td><?php echo $row['me_price'];?></td>
