...
// --> 
   ...
   <div class="row">
       ...
       <div class="py-5 text-center">
        ...
        <h2 style="color: #ff6000;"><?php echo $iribanza;?></h2>
      </div>
      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        ...
        <div class="card card-signin my-5" style="border-top: 4px solid #ff6000;border-radius: 5px;">
          ...
          <div class="card-body">
            ...
            <h5 class="card-title text-center" style="font-style: italic;">Dashboard</h5>
                          ...
                          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><?php echo $count_resto;?></td>
                                        <td><?php echo $count_menu;?></td>
